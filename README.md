...
2. Crie uma conta no [Docker Hub](https://hub.docker.com/signup) e crie um repositório.
...
Nos arquivos [Jenkinsfile .Net](./dotnet/Jenkinsfile) e [Jenkinsfile NodeJs](./nodejs/Jenkinsfile) coloque os valores corretos da seguinte variráveis:
